...
void renderScene(const Shader& shader, unsigned planeVAO, unsigned cubeVAO);
...
int main()
{
    ...
    Shader planeShader("ShadowMapping/res/shaders/planeVertex.glsl", "ShadowMapping/res/shaders/planeFragment.glsl");
    Shader depthShader("ShadowMapping/res/shaders/depthVertex.glsl", "ShadowMapping/res/shaders/depthFragment.glsl");
    Shader debugShader("ShadowMapping/res/shaders/debugVertex.glsl", "ShadowMapping/res/shaders/debugFragment.glsl");


    unsigned int planeTexture = loadTexture("ShadowMapping/res/textures/wood.png");
    ...
    unsigned cubeVBO, cubeVAO, planeVBO, planeVAO, quadVBO, quadVAO;
    ...
    unsigned depthMapFrameBufferObject;
    ...
    // populating texture with null data
    ...
    // why do we set the border color of the texture 
    // Documentation semi-explains:
    /*
    ...
    */
    // I will try to figure out if it has a significant visual effect
    ...
    // binding the depth map to the depth framebuffer
    glFramebufferTexture2D(GL_FRAMEBUFFER, GL_DEPTH_ATTACHMENT, GL_TEXTURE_2D, depthMap, 0);

    // unbinding the defualt back framebuffer 
    glDrawBuffer(GL_NONE);
    // unbinding the defualt front framebuffer
    glReadBuffer(GL_NONE);

    // unbinding the framebuffer; framebuffer 0 is the defualt framebuffer
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        // bind back to the defualt framebuffer 
        glBindFramebuffer(GL_FRAMEBUFFER, 0);
        // reset viewport
        ...
        planeShader.setMat4("projectionMatrix", projection);
        ...
        renderScene(planeShader, planeVAO, cubeVAO);
